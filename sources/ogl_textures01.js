...

{
    ...
    const starter = () => {
        ...
        function gradTexture(colors) {
            ...
            while(i--){ gradient.addColorStop(colors[0][i],colors[1][i]); }
...

        {
            ...
            let color_series = [];
            color_series.push({name:"colors created manually, 6 colors", colors: ["#3884AA", "#61686B", "#AA6538", "#61686B", "#AAAA38", "#61686B"]} );
            color_series.push({name:"colors created manually, 4 colors", colors: ['#1B1D1E','#3D4143','#72797D', '#B0BABF']} );
            color_series.push({name:"scale of colors generated by chroma.js, 5 colors", colors: chroma.scale(['#d8b48d', '#5f4121']).mode('lch').colors(5)} );
            color_series.push({name:"scale of colors generated by chroma.js, 15 colors", colors: chroma.scale(['#d8b48d', '#5f4121']).mode('lch').colors(15)} );
            color_series.push({name:"scale of colors generated by chroma.js, 9 colors", colors: chroma.scale(["#00429d", "#96ffea", "lightyellow"]).mode('lch').colors(9)} );
            color_series.push({name:"scale of colors generated by chroma.js, 15 colors", colors: chroma.scale(['white', 'red']).mode('lab').colors(15)} );
            color_series.push({name:"logarithmic color scale generated by chroma.js, 15 colors", colors: chroma.scale(['lightyellow', 'navy']).domain([1, 100000], 7, 'log').colors(15)} );
            ...
            function updateInfo2() {
                ...
                if (colors_params.texture == 'simple') {
                    ...
                    info2.innerHTML += '"+" or "-"  : change the current color';
                } else {
                    info2.innerHTML = 'Gradient texture, ' +
                        color_series[colors_params.current_series].name + "<br>";
                    info2.innerHTML += '"c" : change the color palette <br>';
                    info2.innerHTML += '"s" : simple texture (4 squares)';
